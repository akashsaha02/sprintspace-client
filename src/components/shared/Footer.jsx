  ...
  return (
    <footer className="bg-gray-900 text-white py-10 border-t-2 border-t-slate-950 dark:border-t-slate-600">
      <div className="max-w-[1920px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6 lg:px-12">
        {/* About Section */}
        <div>
          <h2 className="text-2xl font-bold text-sky-400 mb-4">SprintSpace</h2>
          ...
          <div className="flex space-x-4">
            ...
            <a href="#" aria-label="YouTube" className="hover:text-sky-400">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
        ...
        {/* Quick Links Section */}
        <div>
          <h3 className="text-lg font-bold text-sky-400 mb-4">Quick Links</h3>
          <ul className="space-y-2">
            ...
            <li>
              <Link to="/all-events" className="text-gray-400 hover:text-sky-400">
                Upcoming Events
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/register" className="text-gray-400 hover:text-sky-400">
                Join now
              </Link>
            </li>
          </ul>
        ...
        {/* Newsletter Section */}
        <div>
          <h3 className="text-lg font-bold text-sky-400 mb-4">Stay Updated</h3>
          ...
          <form className="flex">
            <input
              ...
              className="w-full px-4 py-2 rounded-l-lg border-2 border-sky-400 focus:outline-none"
            />
            <button
              type="submit"
              className="bg-sky-400 text-white px-6 py-2 rounded-r-lg hover:bg-sky-500 transition"
            >
              Subscribe
            </button>
          </form>
      ...
      <div className="border-t border-gray-700 mt-10 py-4">
        <div className="container mx-auto flex justify-between items-center px-6 lg:px-12">
          ...
          <nav className="flex space-x-4">
            <a href="/privacy-policy" className="text-gray-400 hover:text-sky-400">
              Privacy Policy
            </a>
            <a href="/terms-of-service" className="text-gray-400 hover:text-sky-400">
              Terms of Service
            </a>
          </nav>
        </div>
