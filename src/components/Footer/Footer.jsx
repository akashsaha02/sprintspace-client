      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6 lg:px-12">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link to="/campaigns" className="text-gray-400 hover:text-purple-400">
                All Campaigns
              </Link>
            </li>
            <li>
              <Link to="/login" className="text-gray-400 hover:text-purple-400">
                Sign In
              </Link>
            </li>
            <li>
      ...
      <div className="border-t border-gray-700 mt-10 py-4">
        <div className="container mx-auto flex justify-between items-center px-6 lg:px-12">
          ...
          <nav className="flex space-x-4">
            <a href="/privacy-policy" target="_blank" className="text-gray-400 hover:text-purple-400">
              Privacy Policy
            </a>
            <a href="/terms-of-service" target="_blank" className="text-gray-400 hover:text-purple-400">
              Terms of Service
            </a>
          </nav>
        </div>
