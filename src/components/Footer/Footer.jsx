  ...
  return (
    <footer className="bg-gray-900 text-white py-10 border-t-2 border-t-slate-950 dark:border-t-slate-600">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6 lg:px-12">
        <div>
          <h2 className="text-2xl font-bold text-teal-400 mb-4">SprintSpace</h2>
          <p className="text-gray-400 mb-6 text-justify">SprintSpace connects passionate individuals with meaningful causes, empowering education, healthcare, and startups. Together, we can make a lasting impact.
          </p>
          <div className="flex space-x-4">
            ...
            <a href="#" aria-label="YouTube" className="hover:text-teal-400">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
        ...
        <div>
          <h3 className="text-lg font-bold text-teal-400 mb-4">Stay Updated</h3>
          <p className="text-gray-400 mb-4">Subscribe to our newsletter for the latest updates and insights.</p>
          <form className="flex">
            <input
              type="email"
              placeholder="Enter your email"
              className="w-full px-4 py-2 rounded-l-lg border-2 border-teal-400 focus:outline-none"
            />
            <button
              type="submit"
              className="bg-teal-400 text-white px-6 py-2 rounded-r-lg hover:bg-teal-500 transition">
              Subscribe
            </button>
          </form>
        </div>
