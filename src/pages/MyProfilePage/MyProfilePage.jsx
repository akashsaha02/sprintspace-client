  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-4xl bg-gray-50 dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
        <div className="h-24 bg-sky-400/70 "></div>
        ...
        <div className="text-center py-8">
          ...
          <div className="flex justify-center mt-4 space-x-4">
            <button
              className="flex items-center px-4 py-2 bg-sky-500 text-white rounded-lg shadow hover:bg-sky-600"
      ...
      <div className="mt-8 w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <FaRunning className="text-sky-500 text-3xl mr-4" />
        ...
        >
          <FaRegIdCard className="text-sky-500 text-3xl mr-4" />
          <span className="text-lg font-semibold dark:text-gray-200">
            My Registrations
          </span>
        </button>
          ...
          <div className="modal-box dark:bg-gray-800 bg-white">
            ...
            <form onSubmit={handleUpdateProfile}>
              ...
              <div className="modal-action flex justify-between">
                ...
                <button
                  type="submit"
                  className="py-2 px-4 bg-sky-500 text-white rounded hover:bg-sky-600"
                >
                  Save
                </button>
              </div>
